...
async function main() {
  ...
  const playersData = [
    ...
    { nickname: 'wtavares', name: 'Walter Tavares',         country: 'CV', birthDate: new Date('1992-03-22'), role: 'Pívot' },
    ...
    { nickname: 'jvesely',  name: 'Jan Veselý',             country: 'CZ', birthDate: new Date('1990-04-24'), role: 'Ala-pívot' },
    ...
    { nickname: 'bdublj',   name: 'Bojan Dubljević',        country: 'ME', birthDate: new Date('1991-10-24'), role: 'Pívot' },
    ...
    { nickname: 'gsherma',  name: 'Giorgi Shermadini',      country: 'GE', birthDate: new Date('1989-04-02'), role: 'Pívot' },
    ...
    { nickname: 'melli',    name: 'Nicolo Melli',           country: 'IT', birthDate: new Date('1991-01-26'), role: 'Ala-pívot' },
    ...
    { nickname: 'leday',    name: 'Zach LeDay',             country: 'US', birthDate: new Date('1994-05-30'), role: 'Ala-pívot' },
    ...
    { nickname: 'theis',    name: 'Daniel Theis',           country: 'DE', birthDate: new Date('1992-04-04'), role: 'Pívot' },
    ...
    { nickname: 'motiej',   name: 'Donatas Motiejunas',     country: 'LT', birthDate: new Date('1990-09-20'), role: 'Pívot' },
